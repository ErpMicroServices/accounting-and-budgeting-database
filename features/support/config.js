        ...
        if (this._currentEnvironment == defaultEnvironment()) {
            this._config = {
                database: {
                    ...
                    database: process.env.DATABASE_DATABASE || 'accounting-and-budgeting-database',
                    user: process.env.DATABASE_USER || 'accounting-and-budgeting',
                    password: process.env.DATABASE_PASSWORD || 'accounting-and-budgeting'
                }
            };
        } else {
